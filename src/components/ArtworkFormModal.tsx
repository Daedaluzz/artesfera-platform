  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <div className="relative backdrop-blur-[15px] bg-white/[0.15] dark:bg-brand-black/15 border border-white/[0.25] dark:border-brand-navy-500/30 rounded-2xl">
            {/* Header */}
            <div className="flex items-center justify-between p-6 border-b border-white/[0.2] dark:border-white/[0.1]">
            ...
            {/* Footer */}
            <div className="flex items-center justify-between p-6 border-t border-white/[0.2] dark:border-white/[0.1]">
              <SecondaryButton
                type="button"
                onClick={onClose}
