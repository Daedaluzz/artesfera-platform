              ...
              <div className="relative z-10 max-w-4xl mx-auto">
                ...
                >
                  <p>
                    ...
                    é uma plataforma completa que conecta o universo artístico e cultural brasileiro, 
                    oferecendo ferramentas profissionais para transformar talento em oportunidades reais.
                  </p>
                  ...
                  <p className="text-center mt-8 font-medium">
                    🚀 Transformamos conexões em colaborações que geram impacto real no setor cultural brasileiro
                  </p>
                </motion.div>
              </div>
