...
export default function DaevaContratos() {
  ...
  const handleSendMessage = async () => {
    ...
    setTimeout(() => {
      const assistantMessage: Message = {
        ...
        type: "assistant",
        content:
          "Olá! Sou a Daeva especializada em contratos artísticos e culturais. Posso ajudá-lo com elaboração, revisão, negociação e aspectos legais de contratos no setor cultural. Como posso ajudá-lo hoje?",
        timestamp: new Date(),
      };
  ...
  const suggestions = [
    {
      icon: FileCheck,
      text: "Como elaborar um contrato de colaboração artística?",
    },
    {
      icon: Scale,
    ...
    {
      icon: AlertTriangle,
      text: "Como proteger direitos autorais em contratos?",
    },
    {
      icon: Users,
      text: "Preciso de um modelo de contrato para evento cultural",
    },
  ];
                ...
                >
                  <div className="flex items-center justify-center gap-3 mb-4">
                    <div className="w-12 h-12 rounded-xl bg-brand-navy-blue/20 dark:bg-brand-yellow/20 backdrop-blur-lg flex items-center justify-center">
                      <MessageSquare className="w-6 h-6 text-brand-navy-blue dark:text-brand-yellow" />
                    </div>
                  ...
                  <p className="text-sm sm:text-base text-brand-black/70 dark:text-brand-white/70 max-w-xl mx-auto leading-relaxed">
                    Especialista em contratos artísticos, direitos autorais e
                    aspectos legais culturais
                  </p>
                </motion.div>
              ...
              <div className="space-y-4">
                {messages.map((message) => (
                  ...
                  >
                    ...
                    >
                      {message.type === "assistant" ? (
                        <MessageSquare className="w-3.5 h-3.5 text-brand-navy-blue dark:text-brand-yellow" />
                      ) : (
                ...
                {isLoading && (
                  ...
                  >
                    <div className="w-7 h-7 rounded-full bg-brand-navy-blue/15 dark:bg-brand-yellow/15 flex items-center justify-center backdrop-blur-lg">
                      <MessageSquare className="w-3.5 h-3.5 text-brand-navy-blue dark:text-brand-yellow animate-pulse" />
                    </div>
            ...
            <div className="max-w-2xl mx-auto relative">
              <div className="relative rounded-[18px] backdrop-blur-[12px] bg-white/[0.2] dark:bg-white/[0.1] border border-white/[0.25] dark:border-white/[0.15] shadow-[0_6px_25px_rgba(0,0,0,0.08),inset_0_1px_0_rgba(255,255,255,0.4),inset_0_-1px_0_rgba(255,255,255,0.1),inset_0_0_15px_8px_rgba(255,255,255,0.08)] dark:shadow-[0_6px_25px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.25),inset_0_-1px_0_rgba(255,255,255,0.04),inset_0_0_15px_8px_rgba(255,255,255,0.04)]">
                <textarea
                  ...
                  placeholder="Pergunte sobre contratos artísticos, direitos autorais..."
                  rows={1}
