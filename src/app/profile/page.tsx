          ...
          <div className="lg:col-span-1">
            <div className="backdrop-blur-md bg-white/20 dark:bg-gray-800/20 border border-white/20 dark:border-gray-700/30 rounded-3xl p-6 shadow-lg sticky top-24">
              ...
              <div className="text-center mb-6">
                ...
                <h2 className="text-xl font-bold text-gray-800 dark:text-white">João Silva</h2>
                <p className="text-gray-600 dark:text-gray-300">Artista Visual</p>
            ...
            <div className="backdrop-blur-md bg-white/20 dark:bg-gray-800/20 border border-white/20 dark:border-gray-700/30 rounded-3xl p-8 shadow-lg">
              ...
              <form className="space-y-6">
                ...
                <div className="border-t border-gray-300/30 dark:border-gray-600/30 pt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label htmlFor="artistType" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
                        Tipo de Artista
                      </label>
                      <select
                        id="artistType"
                    ...
                    <div>
                      <label htmlFor="experience" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
                        Experiência
                      </label>
                      <select
                        id="experience"
                      ...
                      >
                        ...
                        <option value="intermediate">Intermediário (3-5 anos)</option>
                        <option value="experienced">Experiente (6-10 anos)</option>
                  ...
                  <div className="mt-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      {['Pintura', 'Escultura', 'Arte Digital', 'Instalações', 'Performance'].map((skill) => (
                        <span
                          key={skill}
