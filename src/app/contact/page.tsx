    ...
    <div className="py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <motion.div
          ...
          className="backdrop-blur-[15px] bg-white/[0.15] dark:bg-black/15 border border-white/[0.25] dark:border-white/15 rounded-[20px] p-8 shadow-[0_8px_32px_rgba(0,0,0,0.08),inset_0_1px_0_rgba(255,255,255,0.4),inset_0_-1px_0_rgba(255,255,255,0.1),inset_0_0_20px_10px_rgba(255,255,255,0.08)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.25),inset_0_-1px_0_rgba(255,255,255,0.05),inset_0_0_20px_10px_rgba(255,255,255,0.04)]"
        >
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 rounded-[12px] bg-gradient-to-r from-brand-navy-blue to-brand-blue dark:from-brand-yellow dark:to-brand-blue flex items-center justify-center backdrop-blur-sm">
                  <svg
                    className="w-6 h-6 text-white dark:text-brand-black"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 rounded-[12px] bg-gradient-to-r from-brand-blue to-brand-yellow dark:from-brand-blue dark:to-brand-navy-blue flex items-center justify-center backdrop-blur-sm">
                  <svg
                    className="w-6 h-6 text-white dark:text-brand-black"
                    fill="none"
                    stroke="currentColor"
              ...
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 rounded-[12px] bg-gradient-to-r from-brand-yellow to-brand-navy-blue dark:from-brand-navy-blue dark:to-brand-yellow flex items-center justify-center backdrop-blur-sm">
                  <svg
                    className="w-6 h-6 text-white dark:text-brand-black"
                    fill="none"
                    stroke="currentColor"
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-brand-black/70 dark:text-brand-white/70">
                  Clique em "Cadastrar" no menu superior e preencha seus dados.
                  É rápido e gratuito!
                </p>
              </div>
